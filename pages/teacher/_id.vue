      ...
      <div class="t-infor-wrap">
        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            ...
            <h3 class="hLh30">
              <span class="fsize24 c-333">{{teacherInfo.name}}&nbsp;
            ...
            <section class="t-infor-txt">
              <p
                class="mt20">{{teacherInfo.career}}</p>
            </section>
            <div class="clear"></div>
          </div>
        </section>
...
export default {
  ...
  asyncData({ params, error }) {
    return teacher.getTeacherFrontInfo(params.id)
      .then(response => {
        return {
          teacherInfo: response.data.data.teacher,
